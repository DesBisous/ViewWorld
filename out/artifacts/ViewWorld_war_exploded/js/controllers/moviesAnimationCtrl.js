/**
 * Created by Benson on 2016/11/5.
 */
app.controller('moviesAnimationCtrl', ['$scope','$state','musicService','Util','dataService', function($scope,$state,musicService,Util,dataService) {
